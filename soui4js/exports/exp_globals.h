...
HINSTANCE shellExecute(HWND hWnd,LPCSTR pszOp,LPCSTR pszFile,LPCSTR pszParam,LPCSTR pszDir,int show) {
...
void Exp_Global(qjsbind::Module* module)
{
	...
	module->ExportFunc("shellExecute", &shellExecute);
	module->ExportFunc("fork", &fork);
